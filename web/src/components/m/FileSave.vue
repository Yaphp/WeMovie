    ...
    >
        ...
        <div class="file-move-list">
            <div class="file-move-item" v-if="addFolderVisible">
                <div class="file-left">
                    ...
                    <div class="file-name">
                        <el-input v-model="newFile.name" style="width:130px"></el-input>
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <div class="right">
                    <el-button type="primary" @click="handleConfirm">保存到此处</el-button>
                </div>
            </div>
        </template>
    </el-dialog>
...
<script>
import {fileList, fileAdd, fileSave} from "api/file";
            ...
            fileSave({
                ...
                if (res.code === 0) {
                    ...
                    this.$notify({
                        ...
                        message: `保存成功, <a href="/#/files?pid=${this.pid}">立即查看</a>`,
                        type: 'success',
                    });
                } else {
