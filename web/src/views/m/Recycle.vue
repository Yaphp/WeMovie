<template>
    ...
    <van-action-sheet class="action-sheet-bgcolor" safe-area-inset-bottom v-model:show="activeMenuVisible">
        ...
        <van-cell-group class="cell-group-margin" inset>
            ...
            <van-cell title="恢复" @click="handleRecoverFile">
                <template #right-icon>
                    <van-icon name="replay" class="action-icon"/>
                </template>
            </van-cell>
            <van-cell title="彻底删除" @click="handleDeleteFile" title-style="color:red;">
                <template #right-icon>
...
import {fileList, fileDelete, fileUpdate, fileFavorite, fileRecover} from "api/file";
...
export default {
    ...
    data() {
        return {
            ...
            breadcrumb: [{id: "all", name: "回收站"}], // 面包屑导航
            fileList: [], // 文件列表
